...
print('============================================================')
print('📥 دریافت داده‌ها (نسخه V9 - استراتژی بازطراحی‌شده با مومنتوم RSI)')
print('============================================================')
...
print('⚙️ شروع اجرای بک‌تست نسخه V9 (با فیلتر RSI و تاییدیه مومنتوم)...')
...
for ts in sorted_timestamps:
  ...
  for symbol, dat in processed_data.items():
    ...
    # شرط لانگ با فیلتر مومنتوم RSI (بالای ۵۰)
    if (
    ...
    # شرط شورت با فیلتر مومنتوم RSI (زیر ۵۰)
    elif (
...
print('\n============================================================')
print('📊 گزارش نهایی نسخه V9 (واقعی و اصلاح‌شده با فیلتر RSI)')
print('============================================================')
