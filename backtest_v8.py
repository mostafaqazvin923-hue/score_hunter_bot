...
def run_backtest():
    ...
    print("==================================================")
    print(" SCORE HUNTER PRO - HIGH FREQUENCY HIGH WIN-RATE")
    print("==================================================")
    ...
    for symbol in SYMBOLS:
        ...
        for i in range(50, len(candles) - 1):
            ...
            # شرایط ورود با فرکانس بالاتر (تعداد معاملات بیشتر در روز)
            is_down_trend = ema20 < ema50
            is_short = (c["close"] < c["open"]) and (c["close"] < ema20) and (rsi < 55)
            ...
            if is_down_trend and is_short:
                ...
                if 0 < (risk_dist / entry_price) <= 0.04:
                    # هدف‌گذاری پویا برای بالا بردن وین‌ریت (RR 1.2 به جای 2.0 سنگین برای صید سریع‌تر سود)
                    take_profit = entry_price - (risk_dist * 1.2)
                    ...
                    if trade_won: 
                        wins += 1; balance += (risk_amount * 1.2)
                    elif trade_lost: 
            ...
            if not trade_taken:
                ...
                is_long = (c["close"] > c["open"]) and (c["close"] > ema20) and (rsi > 45)
    ...
    print("\n==================================================")
    print("      AGGREGATED HIGH FREQ HIGH WIN-RATE RESULTS  ")
    print("==================================================")
